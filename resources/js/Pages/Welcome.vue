<template>
    <v-app>
        <v-app-bar
            flat
            height="70"
            class="blur-backdrop border-b px-md-10 bg-background"
        >
            <div
            ...
            >
                ...
                ></v-icon>
                <v-toolbar-title
                    class="font-weight-black tracking-tighter text-h5 text-uppercase"
                >
            ...
            <div v-if="canLogin" class="d-none d-sm-flex align-center ga-5">
                ...
                <template v-else>
                    <v-btn
                        ...
                        variant="text"
                        class="font-weight-bold text-none text-medium-emphasis"
                        >Masuk</v-btn
                    >
                    <v-btn
        ...
        <v-main class="bg-background">
            <section
                class="hero-section position-relative d-flex align-center justify-center"
            >
                    ...
                    <v-row justify="center">
                        <v-col cols="12" md="10" lg="8" class="text-center">
                            <v-fade-transition appear>
                                <div
                                    class="glass-content pa-6 pa-md-12 rounded-xl"
                                >
                                    <v-chip
                                        color="white"
                                        variant="outlined"
                                    ...
                                    >
                                        <v-btn
                                            ...
                                            variant="flat"
                                            rounded="xl"
                                            class="px-12 font-weight-black text-none btn-primary-glow"
                                            @click="
                                        ...
                                        <v-btn
                                            ...
                                            color="white"
                                            rounded="xl"
                                            class="px-10 font-weight-bold text-none border-2"
            ...
            <v-container id="features-section" class="py-16">
                <v-row justify="center">
                    ...
                    >
                        <v-card
                            flat
                            class="pa-10 feature-card-minimal h-100 rounded-xl text-center border-sm bg-surface"
                        >
                            <v-avatar
                                color="primary"
                                variant="tonal"
                            ...
                            <p
                                class="text-body-1 text-medium-emphasis leading-relaxed"
                            >
                                {{ feature.desc }}
                            </p>
                        </v-card>
        ...
        <v-footer class="bg-grey-darken-4 py-12 border-t border-grey-darken-3">
            <v-container>
                <v-row align="center" justify="space-between" no-gutters>
                    ...
                    >
                        <div
                            class="d-flex align-center justify-center justify-md-start mb-2"
                        >
                            <v-icon
                                icon="mdi-warehouse"
                                color="primary"
                            ...
                            ></v-icon>
                            <span
                                class="text-h6 font-weight-black text-white tracking-tighter text-uppercase"
                            >
                                Inven<span class="text-primary">Track</span>
                            </span>
                        </div>
                    ...
                    <v-col cols="12" md="6" class="text-center text-md-right">
                        <div
                            class="d-flex justify-center justify-md-end ga-6 mb-4"
                        >
                            <a
                                @click="$inertia.visit(route('login'))"
                                class="dark-footer-link"
                                >Masuk Admin</a
                            >
                            <a
                                ...
                                >Kebijakan Privasi</a
                            >
                            <a @click="showHelp = true" class="dark-footer-link"
                                >Bantuan</a
                            >
                        </div>
                        <div class="text-caption text-grey-lighten-1">
                            &copy; 2026 <strong>InvenTrack</strong>. All Rights
                            Reserved.
                        </div>
                    </v-col>
                </v-row>
        ...
        <v-dialog v-model="showHelp" max-width="500">
            <v-card rounded="xl" class="pa-4 border-sm shadow-xl bg-surface">
                <v-card-title
                    class="font-weight-bold d-flex align-center pt-4 px-6"
                >
                    <v-icon
                ...
                <v-card-text
                    class="text-body-1 text-medium-emphasis px-6 pb-6 mt-2"
                >
                    Jika Anda mengalami kendala teknis silakan hubungi tim
                    Administrator:
                    <v-list
                        density="comfortable"
                        class="mt-6 bg-background rounded-xl border-sm"
                    >
                        <v-list-item
        ...
        <v-dialog v-model="showPrivacy" max-width="600">
            <v-card rounded="xl" class="pa-4 border-sm shadow-xl bg-surface">
                <v-card-title class="font-weight-bold pt-4 px-6"
                    >Kebijakan Privasi</v-card-title
                >
                <v-card-text
                    class="text-body-2 text-medium-emphasis leading-relaxed px-6 pb-6"
                >
                    <p class="mb-4">
                        Sistem <strong>InvenTrack</strong> berkomitmen menjaga
                        kerahasiaan data operasional gudang Anda.
                    </p>
                </v-card-text>
                <v-card-actions class="px-6 pb-4">
                    <v-spacer></v-spacer>
